...
public class ScrollTexturaPiso : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // Usamos Mathf.Repeat para o loop ser mais estável e não depender de números gigantes.
        ...
        //pisoRenderer.material.SetTextureOffset("_MainTex", new Vector2(offset, 0)); // Aplica o deslocamento à textura principal do material
        // CORREÇÃO: No shader URP Lit, a propriedade da textura principal se chama "_BaseMap".
        pisoRenderer.material.SetTextureOffset("_BaseMap", new Vector2(offset, 0)); // Aplica o deslocamento à textura principal do material
